...
const SearchBar = () => {
  ...
  return showSearch && show ? (
    <div className='p-4 flex flex-col items-center relative ' ref={searchRef}>
      <div className='flex items-center gap-2 w-full sm:w-1/2 bg-gray-200 px-4 py-2 shadow-md'>
      ...
      {search && filteredResult?.length > 0 && (
        <div className='absolute top-full w-full sm:w-1/2 bg-gray-200 p-3 shadow-lg mt-0 z-10'>
